...
import openAIlogo from "../images/openai.253x256.png";
...
export const education = [
  {
    ...
    grade: "4.0/4.0 CGPA",
    desc: " I am pursuing an MSc in Computer Software Engineering, working under Dr. Rushi Vyas on a project focused on 'Respiration Rates and Cough Detection using Machine Learning with Wearable Capacitive Touchpads in Smartphones'. My research involves creating and deploying machine learning models to analyze data from capacitive touchpads, accurately detecting respiration rates and coughs. This work has improved diagnostic accuracy by up to 95%. This project enables me to combine my full-stack development skills with machine-learning techniques to develop effective and innovative solutions.",
  ...
  },
  {
    ...
    grade: "8.1/10 CGPA",
    desc: "I completed my B.Tech in Electronics and Communications Engineering at VIT, where I developed a strong foundation in electronics and communication systems. I gained hands-on experience in designing and implementing ommunication systems, and embedded systems. My coursework included subjects such as Computer Newtorks, Digital Image Processing, and Data Structure and Algoerithm. I also developed my programming skills in C, C++, and Python.",
...
export const TimeLineData = [
  { year: 2018, text: "Graduated from the VIT University" },
  { year: 2018, text: "Joined TATA Communications as a software engineer" },
  { year: 2021, text: "Got promoted as a senior software engineer" },
  { year: 2022, text: "Got accepted in the Canadian university to pursue MSc" },
  { year: 2024, text: "Graduating from University of Calgary" },
];
